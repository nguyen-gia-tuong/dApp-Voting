...
| Họ tên | MSSV | Vai trò |
|--------|------|---------|
| Nguyễn Gia Tường | — | Smart contract + deploy |
| Trần Thái Thanh | — | Frontend + UX |
| ... | — | ... |

> 📝 Cập nhật bảng này với thông tin chính xác của nhóm trước khi nộp.

---

## 📚 Tham khảo

- Đề bài: `BaiTapNhom_dApp_Voting.pdf` (cùng repo)
...
**VoteChain** — Bài tập môn Công nghệ chuỗi khối · UEH 2026
